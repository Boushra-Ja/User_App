...
import 'package:b/Home/Company_Pages/Company_Page.dart';
...
class _MyHomePageState extends State<MyHomePage> {
  ...
  CollectionReference jobsref = FirebaseFirestore.instance.collection(
      "company");
                          ...
                          decoration: InputDecoration(
                            contentPadding: EdgeInsets.fromLTRB(0.1, 0.1, 20, 0.1),
                              ...
                              enabledBorder: OutlineInputBorder(
                                borderSide: BorderSide(
                                  color: Colors.pink.shade800, width: 1.0,),
